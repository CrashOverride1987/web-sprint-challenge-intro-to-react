...
-It's a different way of applying elements to a DOM, to make it easier, because doing that is hard.

1. Describe component state. 

-It's just information being initialized and changed.
...
-What happens when you use the useEffect code.
